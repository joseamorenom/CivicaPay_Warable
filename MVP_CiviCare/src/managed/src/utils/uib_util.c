...
Elm_Object_Item* uib_util_push_view(char *view_name) {
	...
	if(!strcmp(view_name,"Menu_Inicial")) {
		vc = uib_view_Menu_Inicial_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Configuracion_PIN")) {
		vc = uib_view_Configuracion_PIN_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Menu_2")) {
		vc = uib_view_Menu_2_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Menu_Life")) {
		vc = uib_view_Menu_Life_create(app_nf, NULL);
	} else if(!strcmp(view_name,"view6")) {
		vc = uib_view_view6_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Menu_Pagos")) {
		vc = uib_view_Menu_Pagos_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Pago_Transporte")) {
		vc = uib_view_Pago_Transporte_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Trans_Neg")) {
		vc = uib_view_Trans_Neg_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Trans_aprob")) {
		vc = uib_view_Trans_aprob_create(app_nf, NULL);
	} else if(!strcmp(view_name,"view12")) {
		vc = uib_view_view12_create(app_nf, NULL);
	} else if(!strcmp(view_name,"view13")) {
		vc = uib_view_view13_create(app_nf, NULL);
	} else if(!strcmp(view_name,"view14")) {
		vc = uib_view_view14_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Boton_Panico")) {
		vc = uib_view_Boton_Panico_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Rutas")) {
		vc = uib_view_Rutas_create(app_nf, NULL);
	} else if(!strcmp(view_name,"Report")) {
		vc = uib_view_Report_create(app_nf, NULL);
	}
