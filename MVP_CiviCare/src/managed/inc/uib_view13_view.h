...
#ifndef UIB_VIEW13_VIEW_H_
#define UIB_VIEW13_VIEW_H_
...
typedef struct _uib_view13_view_context {
	...
	struct _uib_view13_control_context *cc;

	/* UI Components in this view */
	Evas_Object *grid12;
	Evas_Object *circle_object_grid12;
	Evas_Object *bg12;
	Evas_Object *circle_object_bg12;
	Evas_Object *genlist2;
	Evas_Object *circle_object_genlist2;
	Elm_Object_Item *genlistitem1;
	Elm_Object_Item *genlistitem2;
	Elm_Object_Item *genlistitem3;
} uib_view13_view_context;
...
uib_view_context *uib_view_view13_destroy(Evas_Object *parent, void *create_callback_param);

void uib_view13_config_CIRCLE_360x360_portrait();
#endif /* UIB_VIEW13_VIEW_H_ */
