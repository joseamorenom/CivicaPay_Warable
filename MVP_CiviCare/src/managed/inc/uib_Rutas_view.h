...
#ifndef UIB_RUTAS_VIEW_H_
#define UIB_RUTAS_VIEW_H_
...
typedef struct _uib_Rutas_view_context {
	...
	struct _uib_Rutas_control_context *cc;

	/* UI Components in this view */
	Evas_Object *grid15;
	Evas_Object *circle_object_grid15;
	Evas_Object *bg15;
	Evas_Object *circle_object_bg15;
	Evas_Object *button14;
	Evas_Object *circle_object_button14;
} uib_Rutas_view_context;
...
uib_view_context *uib_view_Rutas_destroy(Evas_Object *parent, void *create_callback_param);

void uib_Rutas_config_CIRCLE_360x360_portrait();
#endif /* UIB_RUTAS_VIEW_H_ */
